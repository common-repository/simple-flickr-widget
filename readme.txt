...
Contributors: sayful
Tags: flickr, photos, widget, feeds, flickr feeds
...
* You need Flickr ID number, To get Flickr ID number, go to your **Flickr account >> photostream** Now Look at you addressbar, it look like the following **https://www.flickr.com/photos/937xxxx5@N02/**
...
* Search for 'simple-flickr-widget' a plugin will come called 'Simple Flickr Widget' and Click 'Install Now' and confirm your installation by clicking 'ok'
...
* From here, browse for the zip file included in your plugin titled 'simple-flickr-widget.zip' and click the 'Install Now' button
...
2. Screenshot of Simple Flickr Widget Front-end

== Changelog ==

= 1.2.0 - 2017-06-15 =
* Add support to load images over ssl

= version 1.1.0 =
* Removed jQuery library to get feeds.
* Added WordPress cache to better speed.
* Removed Style file and load it at wp_head before theme style.
